package org.rackyun.infra.agent.test.suit.component.mongodb.v3.kmonitor;
...
public class ComponentTest extends AbstractMonitorComponentTest {
    ...
    private static final String TEST_API_PATH = "/test/mongo/v3/run";
    ...
    public void verifyComponent() throws Exception {
        assertTrue("mongodb client metric is not exist", metricsQueryClient.validateMetricsWithOutValue(
                "mongodb_client_requests_seconds_sum", new HashMap<>()));
    }
