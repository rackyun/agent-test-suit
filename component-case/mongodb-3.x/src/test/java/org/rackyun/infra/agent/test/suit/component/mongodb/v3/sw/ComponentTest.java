package org.rackyun.infra.agent.test.suit.component.mongodb.v3.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    private static final String COMPONENT_NAME = "mongodb-driver";
    private static final String TEST_API_PATH = "/test/mongo/v3/run";
    private static final String DEFAULT_APP_CODE = "agent-test-mongodb-3x";
