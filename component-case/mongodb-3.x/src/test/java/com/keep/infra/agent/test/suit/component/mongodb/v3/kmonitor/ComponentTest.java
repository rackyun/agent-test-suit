package com.keep.infra.agent.test.suit.component.mongodb.v3.kmonitor;
...
public class ComponentTest extends AbstractKeepMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        ...
        FalconMetricEntry[] targetMetric = FalconMetricUtil.findMetric(metricEntries, "mongodb.client.timer.count");
