package com.keep.infra.agent.test.suit.component.hbase.v1.kmonitor;
...
public class ComponentTest extends AbstractKeepMonitorComponentTest {
    ...
    private static final String TEST_API_PATH = "/test/hbase/v1/run";
    ...
    public void verifyComponent() throws Exception {
        ...
        FalconMetricEntry[] targetMetric = FalconMetricUtil.findMetric(metricEntries, "hbase.client.timer.count");
