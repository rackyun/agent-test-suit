package com.keep.infra.agent.test.suit.component.hbase.v1.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    private static final String DEFAULT_APP_CODE = "agent-test-hbase1x";
    ...
    public void agentTest() throws Exception {
        ...
        String appName = "agent-test-hbase1x-" + random.nextInt(9999);
