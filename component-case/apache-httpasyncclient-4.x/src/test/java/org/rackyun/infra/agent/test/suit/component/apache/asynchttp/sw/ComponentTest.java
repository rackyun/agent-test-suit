package org.rackyun.infra.agent.test.suit.component.apache.asynchttp.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    private static final String COMPONENT_NAME = "httpasyncclient";
    private static final String TEST_API_PATH = "/test/apacheasynchttp/v4/run";
    ...
    public void verifyComponent() throws Exception {
        ...
        assertEquals(String.format("%s not be register", getAppName()), 1, services.length);
