...
package org.rackyun.infra.agent.test.suit.component.apache.asynchttp.util;
...
public class HttpAsyncClient {
    ...
    public static String get(String url, List<NameValuePair> params) throws IOException {
        ...
        return asyncExecute(url, httpget, null);
    }

    private static String asyncExecute(String url, HttpUriRequest httpRequest, FutureCallback<HttpResponse> callback) {
        CloseableHttpAsyncClient httpAsyncClient = HttpAsyncClients.createDefault();
        try {
            if (!httpAsyncClient.isRunning()) {
                httpAsyncClient.start();
            }
            HttpResponse response = (HttpResponse) httpAsyncClient.execute(httpRequest, callback).get();
    ...
    public static String jsonPost(String url, List<NameValuePair> params, String content) throws IOException {
        ...
        return asyncExecute(url, httpPost, null);
    }
