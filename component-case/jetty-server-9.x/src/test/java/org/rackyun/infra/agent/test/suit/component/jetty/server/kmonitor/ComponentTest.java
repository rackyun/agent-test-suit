package org.rackyun.infra.agent.test.suit.component.jetty.server.kmonitor;
...
public class ComponentTest extends AbstractMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        Assert.assertTrue("jetty server metric is not exist", metricsQueryClient.validateMetricsWithOutValue(
