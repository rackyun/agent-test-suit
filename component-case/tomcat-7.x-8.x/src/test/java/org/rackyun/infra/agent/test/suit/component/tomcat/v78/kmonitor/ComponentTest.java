package org.rackyun.infra.agent.test.suit.component.tomcat.v78.kmonitor;
...
public class ComponentTest extends AbstractMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        Assert.assertTrue("http server metric is not exist", metricsQueryClient.validateMetricsWithOutValue(
                "http_server_requests_seconds_sum", new HashMap<>()));
    }
