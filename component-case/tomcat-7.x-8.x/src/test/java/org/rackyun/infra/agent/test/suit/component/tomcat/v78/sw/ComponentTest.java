package org.rackyun.infra.agent.test.suit.component.tomcat.v78.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    private static final String COMPONENT_NAME = "Tomcat";
    private static final String TEST_API_PATH = "/test/tomcat/v78/run";
    private static final String DEFAULT_APP_CODE = "agent-test-tomcat-v78";
