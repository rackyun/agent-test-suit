package com.keep.infra.agent.test.suit.component.mysql.v5x.kmonitor;
...
public class ComponentTest extends AbstractKeepMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        ...
        FalconMetricEntry[] targetMetric = FalconMetricUtil.findMetric(metricEntries, "mysql.client.timer.count");
