package org.rackyun.infra.agent.test.suit.component.mysql.v5x.kmonitor;
...
public class ComponentTest extends AbstractMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        assertTrue("mysql client metric is not exist", metricsQueryClient.validateMetricsWithOutValue(
                "mysql_client_requests_seconds_sum", new HashMap<>()));
    }
