package org.rackyun.infra.agent.test.suit.component.mysql.v5x.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    private static final String COMPONENT_NAME = "mysql-connector-java";
    private static final String TEST_API_PATH = "/test/mysql/v5/run";
    private static final String DEFAULT_APP_CODE = "agent-test-mysql-5x";
    ...
    public void agentTest() throws Exception {
        ...
        String appName = "agent-test-mysql-5x-" + random.nextInt(9999);
