package com.keep.infra.agent.test.suit.component.jedis.v2.kmonitor;
...
public class ComponentTest extends AbstractKeepMonitorComponentTest {
    ...
    private static final String TEST_API_PATH = "/test/jedis/v2/run";
    ...
    public void verifyComponent() throws Exception {
        ...
        FalconMetricEntry[] targetMetric = FalconMetricUtil.findMetric(metricEntries, "jedis.pool.get.resource.error");
//        assertTrue("hbase client metric is not exist", targetMetric.length > 0);
    }
