package org.rackyun.infra.agent.test.suit.component.jedis.v2.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    private static final String COMPONENT_NAME = "Jedis";
    private static final String TEST_API_PATH = "/test/jedis/v2/run";
    private static final String DEFAULT_APP_CODE = "agent-test-jedis2x";
    ...
    public void agentTest() throws Exception {
        ...
        String appName = "agent-test-jedis2x-" + random.nextInt(9999);
