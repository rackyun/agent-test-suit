package org.rackyun.infra.agent.test.suit.component.jedis.v2.kmonitor;
...
public class ComponentTest extends AbstractMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        assertTrue("jedis client metric is not exist", metricsQueryClient.validateMetricsWithOutValue(
                "redis_client_requests_seconds_seconds_sum", new HashMap<>()));
    }
