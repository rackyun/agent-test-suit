package com.keep.infra.agent.test.suit.component.feign.http.v9x.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    public void agentTest() throws Exception {
        ...
        AgentTestExecutor executor = new AgentTestExecutor(baseDir + "/target/" + "feign-default-http-9.x-exec.jar",//TestConfig.BUILD_JAR_NAME,
                "",
