package org.rackyun.infra.agent.test.suit.component.feign.http.v9x.kmonitor;
...
public class ComponentTest extends AbstractMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        assertTrue("http client metric is not exist", metricsQueryClient.validateMetricsWithOutValue(
