package com.keep.infra.agent.test.suit.component.jetcache.kmonitor;
...
public class ComponentTest extends AbstractKeepMonitorComponentTest {
    ...
    private static final String TEST_API_PATH = "/test/jetcache/run";
    ...
    public void verifyComponent() throws Exception {
        ...
        FalconMetricEntry[] targetMetric = FalconMetricUtil.findMetric(metricEntries, "server.cache.get.count");
        assertTrue("jetCache client metric is not exist", targetMetric.length > 0);
    }
