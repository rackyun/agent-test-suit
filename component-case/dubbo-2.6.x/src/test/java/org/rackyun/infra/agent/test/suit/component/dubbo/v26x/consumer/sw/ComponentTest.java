package org.rackyun.infra.agent.test.suit.component.dubbo.v26x.consumer.sw;
...
public class ComponentTest extends AbstractSkywalkingComponentTest {
    ...
    private static final String COMPONENT_NAME = "Dubbo";
    private static final String TEST_API_PATH = "/test/dubbo/v26/run";
    private static final String DEFAULT_APP_CODE = "agent-test-dubbo";
    ...
    public void agentTest() throws Exception {
        System.out.println(TestConfig.SW_AGENT_PATH);
        System.out.println(TestConfig.BUILD_JAR_NAME);
    ...
    public String getAppName() {
        return StringUtils.defaultIfEmpty(super.getAppName(), DEFAULT_APP_CODE);
    }

    @Override
    public void verifyComponent() throws Exception {
        Service[] services = traceQueryClient.searchServiceCode(getAppName());
        assertEquals(String.format("service %s is not register", getAppName()), 1, services.length);
