package org.rackyun.infra.agent.test.suit.component.elasticsearch.v6.kmonitor;
...
public class ComponentTest extends AbstractMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        assertTrue("elasticsearch client metric is not exist", metricsQueryClient.validateMetricsWithOutValue(
                "elasticsearch_client_requests_seconds_sum", new HashMap<>()));
    }
