package com.keep.infra.agent.test.suit.component.elasticsearch.v6.kmonitor;
...
public class ComponentTest extends AbstractKeepMonitorComponentTest {
    ...
    public void verifyComponent() throws Exception {
        ...
        FalconMetricEntry[] targetMetric = FalconMetricUtil.findMetric(metricEntries, "elasticsearch.client.timer.count");
        assertTrue("elasticsearch client metric is not exist", targetMetric.length > 0);
    }
