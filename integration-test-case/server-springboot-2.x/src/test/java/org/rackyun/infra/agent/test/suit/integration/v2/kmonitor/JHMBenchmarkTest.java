package org.rackyun.infra.agent.test.suit.integration.v2.kmonitor;
...
public class JHMBenchmarkTest {
    ...
    private List<AbstractMonitorComponentTest> componentTestList = new ArrayList<>();
    ...
    private void startTargetServer() throws Exception {
        ...
        executor = new AgentTestExecutor(baseDir + "/target/server-springboot-2.x.jar",
                "",
    ...
    public void testApiInvoke() throws Exception {
        AbstractMonitorComponentTest componentTest =
